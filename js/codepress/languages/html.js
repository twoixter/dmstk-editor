...
Language.syntax = [
	...
	{ input : /(&lt;\/?vex:[^!]*?&gt;)/g, output : '<v>$1</v>'	}, // tags de vexlan
	{ input : /(&lt;\/?var:[^!]*?&gt;)/g, output : '<va>$1</va>'	}, // tags de vexlan (Variables)
	{ input : /(&lt;\/?vex:content [^!]*?&gt;)/g, output : '<vc>$1</vc>'	}, // tags de vexlan (Contenido)
	{ input : /(&lt;\/?vex:mensajes [^!]*?&gt;)/g, output : '<vm>$1</vm>'	}, // tags de vexlan (Mensajes)
	{ input : /(&lt;\/?vex:include [^!]*?&gt;)/g, output : '<vi>$1</vi>'	}, // tags de vexlan (Includes)
